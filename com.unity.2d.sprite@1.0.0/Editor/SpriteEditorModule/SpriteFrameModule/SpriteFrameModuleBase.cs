...
namespace UnityEditor.U2D.Sprites
{
    ...
    internal abstract partial class SpriteFrameModuleBase : SpriteEditorModuleBase
    {
        ...
        public UnityEngine.SpriteAlignment selectedSpriteAlignment
        { 
        ...
        public void SetSpritePivotAndAlignment(Vector2 pivot, UnityEngine.SpriteAlignment alignment)
        {
        ...
        protected void SnapPivotToSnapPoints(Vector2 pivot, out Vector2 outPivot, out UnityEngine.SpriteAlignment outAlignment)
        {
            ...
            UnityEngine.SpriteAlignment snappedAlignment = UnityEngine.SpriteAlignment.Custom;
            ...
            for (int alignment = 0; alignment < snapPoints.Length; alignment++)
            {
                ...
                {
                    snappedAlignment = (UnityEngine.SpriteAlignment)alignment;
        ...
        protected void SnapPivotToPixels(Vector2 pivot, out Vector2 outPivot, out UnityEngine.SpriteAlignment outAlignment)
        {
            outAlignment = UnityEngine.SpriteAlignment.Custom;
