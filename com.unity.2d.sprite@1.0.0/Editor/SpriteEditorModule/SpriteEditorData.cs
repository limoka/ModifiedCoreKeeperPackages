...
namespace UnityEditor.U2D.Sprites
{
    internal class SpriteDataExt : SpriteRect
    {
        ...
        internal SpriteDataExt(SerializedObject so)
        {
            ...
            alignment = (UnityEngine.SpriteAlignment)so.FindProperty("m_Alignment").intValue;
        ...
        internal SpriteDataExt(SerializedProperty sp)
        {
            ...
            alignment = (UnityEngine.SpriteAlignment)sp.FindPropertyRelative("m_Alignment").intValue;
