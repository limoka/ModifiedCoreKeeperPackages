...
namespace UnityEditor.U2D.Sprites
{
    ...
    {
        public static Vector2 GetPivotValue(UnityEngine.SpriteAlignment alignment, Vector2 customOffset)
        {
            switch (alignment)
            {
                case UnityEngine.SpriteAlignment.BottomLeft:
                    return new Vector2(0f, 0f);
                case UnityEngine.SpriteAlignment.BottomCenter:
                    return new Vector2(0.5f, 0f);
                case UnityEngine.SpriteAlignment.BottomRight:
                    return new Vector2(1f, 0f);

                case UnityEngine.SpriteAlignment.LeftCenter:
                    return new Vector2(0f, 0.5f);
                case UnityEngine.SpriteAlignment.Center:
                    return new Vector2(0.5f, 0.5f);
                case UnityEngine.SpriteAlignment.RightCenter:
                    return new Vector2(1f, 0.5f);

                case UnityEngine.SpriteAlignment.TopLeft:
                    return new Vector2(0f, 1f);
                case UnityEngine.SpriteAlignment.TopCenter:
                    return new Vector2(0.5f, 1f);
                case UnityEngine.SpriteAlignment.TopRight:
                    return new Vector2(1f, 1f);

                case UnityEngine.SpriteAlignment.Custom:
                    return customOffset;
            }
            return Vector2.zero;
        }
