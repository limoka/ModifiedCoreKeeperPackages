...
namespace Unity.Scenes
{
    ...
    class LiveConversionSceneChangeTracker
    {
        ...
        private NativeList<Entities.SceneReference>  m_PreviousScenes;
        ...
        public LiveConversionSceneChangeTracker(EntityManager manager)
        {
            ...
            m_PreviousScenes = new NativeList<Entities.SceneReference>(Allocator.Persistent);
        ...
        public bool GetSceneMessage(out LiveConversionSceneMsg msg)
        {
            ...
            var loadedScenes = _LoadedScenesQuery.ToComponentDataArray<Entities.SceneReference>(Allocator.TempJob);
