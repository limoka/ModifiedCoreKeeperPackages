...
namespace Unity.Scenes
{
    ...
    class LiveLinkResolveSceneReferenceSystem : ComponentSystem
    {
        ...
        void ResolveScene(Entity sceneEntity, ref Unity.Entities.SceneReference scene, RequestSceneLoaded requestSceneLoaded, Hash128 artifactHash)
        {
        ...
        protected override void OnUpdate()
        {
            ...
            // requested' state.
            Entities.With(m_ResolvedScenes).ForEach((Entity sceneEntity, ref Unity.Entities.SceneReference scene, ref ResolvedSceneHash resolvedScene) =>
            {
            ...
            Entities.With(m_WaitingForEditorScenes).ForEach((Entity sceneEntity, ref Unity.Entities.SceneReference scene, ref RequestSceneLoaded requestSceneLoaded) =>
            {
                var subSceneGUID = new SubSceneGUID(scene.SceneGUID, buildConfigurationGUID);
            ...
            Entities.With(m_NotYetRequestedScenes).ForEach((Entity sceneEntity, ref Unity.Entities.SceneReference scene, ref RequestSceneLoaded requestSceneLoaded) =>
            {
                var subSceneGUID = new SubSceneGUID(scene.SceneGUID, buildConfigurationGUID);
