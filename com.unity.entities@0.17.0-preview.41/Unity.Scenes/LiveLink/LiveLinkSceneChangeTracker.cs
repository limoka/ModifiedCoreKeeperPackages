...
namespace Unity.Scenes
{
    ...
    class LiveLinkSceneChangeTracker
    {
        ...
        private NativeList< Unity.Entities.SceneReference>  m_PreviousScenes;
        ...
        {
            _LoadedScenesQuery = manager.CreateEntityQuery(typeof(Unity.Entities.SceneReference));
            _UnloadedScenesQuery = manager.CreateEntityQuery(ComponentType.Exclude<Unity.Entities.SceneReference>(), ComponentType.ReadOnly<LiveLinkPatcher.LiveLinkedSceneState>());
            m_PreviousScenes = new NativeList<Unity.Entities.SceneReference>(Allocator.Persistent);
        ...
        public bool GetSceneMessage(out LiveLinkSceneMsg msg)
        {
            ...
            var loadedScenes = _LoadedScenesQuery.ToComponentDataArray<Unity.Entities.SceneReference>(Allocator.TempJob);
