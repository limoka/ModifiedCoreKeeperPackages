...
namespace TMPro
{
        ...
        IScrollHandler
    {
        ...
        protected virtual void LateUpdate()
        {
            ...
            //    m_SoftKeyboard.selection = new UnityEngine.RangeInt(stringPositionInternal < stringSelectPositionInternal ? stringPositionInternal : stringSelectPositionInternal, length);
            //}
        ...
        private void GenerateCaret(VertexHelper vbo, Vector2 roundingOffset)
        {
            ...
            if (m_SoftKeyboard != null)
            {
                ...
                m_SoftKeyboard.selection = new UnityEngine.RangeInt(selectionStart, 0);
            }
        ...
        private void GenerateHightlight(VertexHelper vbo, Vector2 roundingOffset)
        {
            ...
            if (m_SoftKeyboard != null)
            {
                ...
                m_SoftKeyboard.selection = new UnityEngine.RangeInt(stringPosition, length);
            }
