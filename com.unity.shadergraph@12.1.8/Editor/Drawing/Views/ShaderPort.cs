...
namespace UnityEditor.ShaderGraph.Drawing
{
    ...
    {
        ShaderPort(Orientation portOrientation, UnityEditor.Experimental.GraphView.Direction portDirection, Capacity portCapacity, Type type)
        ...
        {
            var port = new ShaderPort(Orientation.Horizontal, slot.isInputSlot ? UnityEditor.Experimental.GraphView.Direction.Input : UnityEditor.Experimental.GraphView.Direction.Output,
