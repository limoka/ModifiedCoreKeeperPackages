...
namespace UnityEditor.ShaderGraph.Drawing
{
    ...
    class GraphEditorView : VisualElement, IDisposable
    {
        ...
        void AddContexts()
        {
            ContextView AddContext(string name, ContextData contextData, UnityEditor.Experimental.GraphView.Direction portDirection)
            {
            ...
            var vertexContext = AddContext("Vertex", m_Graph.vertexContext, UnityEditor.Experimental.GraphView.Direction.Output);
            var fragmentContext = AddContext("Fragment", m_Graph.fragmentContext, UnityEditor.Experimental.GraphView.Direction.Input);
