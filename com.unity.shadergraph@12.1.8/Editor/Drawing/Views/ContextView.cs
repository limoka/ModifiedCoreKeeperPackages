...
namespace UnityEditor.ShaderGraph
{
    sealed class ContextView : StackNode
    {
        ...
        public void AddPort(UnityEditor.Experimental.GraphView.Direction direction)
        {
            var capacity = direction == UnityEditor.Experimental.GraphView.Direction.Input ? Port.Capacity.Single : Port.Capacity.Multi;
            var container = direction == UnityEditor.Experimental.GraphView.Direction.Input ? inputContainer : outputContainer;
